...
const RewardAmountDaily = () => {
    ...
    const totalPages = Math.ceil((userData && userData.length) / recordsPerPage);
                        ...
                        <div className='pagination_section_table'>
                            ...
                            <ul className="pagination">
                                <li className={`page-item ${currentPage === 1 ? 'disabled' : ''}`}>
                                    <button onClick={() => paginate(currentPage - 1)} className="page-link rounded-left">
                                ...
                                <li className={`page-item ${currentPage === totalPages ? 'disabled' : ''}`}>
                                    <button onClick={() => paginate(currentPage + 1)} className="page-link rounded-right">
